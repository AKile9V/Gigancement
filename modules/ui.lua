...
function GigaSettingsInterface:UpgradeDefaultCastbar(position)
  ...
  if not PlayerCastingBarFrame.timer then
    ...
    PlayerCastingBarFrame.timer:SetDrawLayer("OVERLAY", 7)
    PlayerCastingBarFrame.timer:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE, SLUG")
  ...
  if not TargetFrameSpellBar.timer then
    ...
    TargetFrameSpellBar.timer:SetDrawLayer("OVERLAY", 7)
    TargetFrameSpellBar.timer:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE, SLUG")
  ...
  if not FocusFrameSpellBar.timer then
    ...
    FocusFrameSpellBar.timer:SetDrawLayer("OVERLAY", 7)
    FocusFrameSpellBar.timer:SetFont(STANDARD_TEXT_FONT, 12, "OUTLINE, SLUG")
